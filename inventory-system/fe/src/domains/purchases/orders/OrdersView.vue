...
const purchaseOrderStore = useOrdersStore()
...
<template>
  <PaperView title="Purchase Orders">
    <button @click="addPurchaseOrder" class="mb-4 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">
      New Purchase Order
    </button>
    ...
    <div class="overflow-auto">
      <table class="min-w-full bg-white border">
        ...
        <tbody>
          <tr v-for="(purchaseOrder, index) in purchaseOrderStore.orderlist" :key="purchaseOrder.id ?? index"
            ...
            <td class="py-2 px-4 border-b text-center">
              <button @click="editProduct(purchaseOrder.id ?? '')" class="text-blue-500 hover:text-blue-700">
